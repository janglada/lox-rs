...
#[cfg(test)]
mod tests {
    use crate::full_scanner::FullScanner;

    #[test]
    fn basic_sum() {
       let mut scanner = FullScanner::new("1 + 1".to_string());
        scanner.scan_tokens();
    ...
    #[test]
    fn var_set() {
        let mut scanner = FullScanner::new("var a = !((1+1)< 0)".to_string());
        scanner.scan_tokens();
        println!("{:?}", scanner.tokens);
    }
    ...
    #[test]
    fn multiline() {
        let mut scanner = FullScanner::new("var a = 1+1\nvar b =  false".to_string());
        scanner.scan_tokens();
        println!("{:?}", scanner.tokens);
    }
    ...
    #[test]
    fn string() {
        let mut scanner = FullScanner::new("var a = \"hello world\"".to_string());
        scanner.scan_tokens();
        println!("{:?}", scanner.tokens);
    }
